...
class Agent():
    ...
    def act(self, state, explore=False):
        ...
        ======
            ...
            explore (boolean): use exploration based on decaying epsilon 
    ...
    def learn(self, experiences, gamma, t_step):
        ...
        # Double Learning: local network used for getting max actions, target network used for action values.
